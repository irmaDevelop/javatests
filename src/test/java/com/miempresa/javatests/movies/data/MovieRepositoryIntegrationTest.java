...
public class MovieRepositoryIntegrationTest {
    ...
    public void setUp() throws Exception {
        //ESTOY CONECTANDOME A LA BASE DE DATOS: para conseguir conexion a la base de datos.

        dataSource =
                new DriverManagerDataSource("jdbc:h2:mem:test;MODE=MYSQL", "sa", "sa");

        //EJECUTO EL SCRIPT PARA CREAR LA TABLA DE PELÍCULAS: Esta utilidad tambien viene en la libreria JDBC

        ScriptUtils.executeSqlScript(dataSource.getConnection(), new ClassPathResource("sql-scripts/test-data.sql"));

        //CREAMOS EL JDBCTEMPLATE QUE NECESITA MI REPOSITORIO
    ...
    public void insert_a_movie(){
        ...
        //Para veirifcar que se recuperó
    ...
    //reto pendiente
    // https://platzi.com/clases/1503-testing-java/17390-reto-34316/
}